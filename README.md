...
When I was creating **SetUp()**, I managed to get a visual regression testing done. This is for future reference if more work needs to be done. For this, I signed up with [Percy website][Source16] and I approved the screenshot on my Percy dashboard. The screenshot can be found in my local repository with the following address:
