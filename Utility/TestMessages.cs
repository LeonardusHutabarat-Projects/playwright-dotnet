...
namespace TechnicalAssessment.Utility
{
    ...
    {
        public const string ConsentText = "Consent";
        public const string AutomationPracticeAlt = "Website for automation practice";
        public const string CarouselVisiblePrefix = "Carousel visible: {0}";
        public const string ActiveSlideText = "Active slide text: {0}";
        public const string CarouselSlideCount = "Expected 3 slides on carousel, but found {0}";
